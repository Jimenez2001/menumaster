...
export default function caja() {
  ...
  const getOrdenes = async (id) => {
    try {
      const url = `https://bloody-carriage-production.up.railway.app/api/ordenes/mesas/${id}`;
      const { data } = await axios(url);
      console.log(data);
      setOrdenes(data);
    } catch (error) {
    ...
    try {
      ...
      const producto = {
        product: {
          ...
          cancel_url: "https://bloody-carriage-production.up.railway.app/caja",
          success_url: "https://bloody-carriage-production.up.railway.app/caja",
